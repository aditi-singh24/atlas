...
const { activeEventsList } = require('./ingestion/eventFeed');
 ...
 */
app.get('/api/predictions/:segmentId', (req, res) => {
 ...
 */
app.get('/api/ingestion/summary', (req, res) => {
  res.json({
    liveTraffic: getLiveTrafficFeed(),
